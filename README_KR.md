...
-   [x] 운영체제 지원 - Windows and macOS
-   [x] macOS Apple Silicon에서 Dock 최소화/복원 및 표준 창 제어 지원
-   [x] 다중언어 지원
...
1. 최신버전 다운로드 페이지 [Release](https://github.com/douxy1994/pot-desktop/releases/latest)에서 `.exe` 파일을 다운받습니다.
...
-   설치 후 프로그램창이 보이지 않거나 오른쪽 하단 시스템 트레이 항목에 아이콘이 표시되지 않을 경우,
    ...
    회사/기업 사용자의 경우 WebView2 기능이 설치되지 않았거나 비활성화된 경우가 있습니다. 이 경우 다음을 설치하십시오. WebView2 version `pot_{version} at [Release](https://github.com/douxy1994/pot-desktop/releases/latest) _{arch}_fix_webview2_runtime-setup.exe`
...
1. 최신버전 다운로드 페이지 [Release](https://github.com/douxy1994/pot-desktop/releases/latest)에서 `.dmg` 파일을 다운받습니다. (M1 사용자이면, 다음 파일명을 다운로드 합니다 `pot_{version}_aarch64.dmg`, 기타 사용자는 다음 파일을 다운로드 합니다. `pot_{version}_x64.dmg`)
2. 더블클릭하여 설치를 합니다.
...
OCR 및 번역을 위해서 pot은 자체 스크린샷(화면캡쳐)기능을 사용하지 않을 수 있습니다. 자체 화면캡쳐 툴을 사용할 수 있습니다.
...
2. DSnipDo 확장팩을 최신버전 다운 경로에서 [Release](https://github.com/douxy1994/pot-desktop/releases/latest) (pot.pbar) 다운받습니다.
3. 더블클릭하여 설치합니다.
...
2. PopClip 확장팩을 최신버전 다운 경로에서 [Release](https://github.com/douxy1994/pot-desktop/releases/latest) (pot.popclipextz) 다운받습니다.
3. 더블클릭하여 설치합니다.
